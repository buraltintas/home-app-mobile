...
import {FavoritesScreen} from './src/screens/SecondaryScreens';
...
function AppShell(){
  const {t}=useI18n();const [auth,setAuth]=useState(false);const [email,setEmail]=useState(false);const [store,setStore]=useState<string|null>(null);const [signedIn,setSignedIn]=useState(false);const [reduceMotion,setReduceMotion]=useState(false);const openAuth=()=>setAuth(true);
