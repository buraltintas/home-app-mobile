...
- Native clients are the explicit direct-backend transport exception.
- Anonymous browsing is first-class; social mutations and reviews require authentication.
- Respect iOS and Android conventions, safe areas, reduced motion, Dynamic Type where practical, and 44×44 minimum touch targets.

## Brand Commitments

The approved name is **Boşa Gezme!** and the canonical domain is `bosagezme.com`. Preserve Turkish diacritics and the exclamation mark. Use the approved hunting-dog assets in `assets/brand/` sparingly; real store content remains dominant. Copy is direct, warm, and free of AI hype.
