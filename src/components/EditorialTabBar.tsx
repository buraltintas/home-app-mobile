...
const tabColors:Record<string,string>={home:colors.accent,search:'#A66F2E',favorites:'#B64F65',profile:'#536C72'};
...
const styles=StyleSheet.create({zone:{position:'absolute',left:0,right:0,bottom:0,zIndex:100,elevation:100,backgroundColor:'transparent',justifyContent:'flex-start'},rail:{height:60,marginHorizontal:spacing.lg,marginTop:4,zIndex:101,backgroundColor:'rgba(255,255,255,.04)',borderWidth:1,borderColor:'rgba(255,255,255,.58)',borderRadius:24,paddingHorizontal:0,flexDirection:'row',alignItems:'center',shadowColor:colors.ink,shadowOffset:{width:0,height:10},shadowOpacity:.14,shadowRadius:24,elevation:101,overflow:'visible'},glassClip:{position:'absolute',top:0,right:0,bottom:0,left:0,borderRadius:24,overflow:'hidden'},glassTint:{position:'absolute',top:0,right:0,bottom:0,left:0,backgroundColor:'rgba(255,254,251,.22)'},indicator:{position:'absolute',left:0,top:8,width:44,height:44,borderRadius:15,backgroundColor:'rgba(255,255,255,.5)',borderWidth:1,borderColor:'rgba(255,255,255,.74)',shadowColor:colors.ink,shadowOffset:{width:0,height:3},shadowOpacity:.09,shadowRadius:8,elevation:2},item:{flex:1,height:60,alignItems:'center',justifyContent:'center',zIndex:102,elevation:102},itemInner:{alignItems:'center',justifyContent:'center'},createOrb:{width:48,height:48,borderRadius:24,zIndex:103,elevation:103,backgroundColor:colors.accent,alignItems:'center',justifyContent:'center',shadowColor:colors.accentStrong,shadowOffset:{width:0,height:6},shadowOpacity:.3,shadowRadius:11,overflow:'hidden'},createOrbActive:{backgroundColor:colors.accentStrong,shadowOpacity:.36,shadowRadius:14}});
